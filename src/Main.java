...
//
        //operations.open("C:\\Users\\Bogson\\IdeaProjects\\PersonalCalendar\\src\\XMLFiles\\SportCalendar.xml");
        //operations.getFileParser().getFileContent().add(calendarEvent);
        //operations.saveAs("C:\\Users\\Bogson\\IdeaProjects\\PersonalCalendar\\src\\XMLFiles\\TestCalendar.xml");
        //operations.close();
//
